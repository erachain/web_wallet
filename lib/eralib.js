...
/**
 * Create key pair using specific version
 * 
 * @param {*} version the version of cryptography
 * @param {*} seed base seed
 */
function createKeyPairByVersion(version, seed) {
	switch (version) {
		case 0:
...
/**
 * Generate key pair by seed. First two byte is version cryptografy.
 * 
 * @param {*} seed the first two byte in base seed is version cryptografy. 
 */
