var sendAsset = "<h5>Send Asset</h5>" +
    ...
    "<div class='input-group'><p style='min-width:150px;'>Asset Key:</p><input style='max-width:250px;' class='form-control' type='text' value='1' id='assetkey'>&nbsp;" +
    "<input style='max-width:90px;' class='btn btn-default' type='button' value='Search' OnClick='sendAssetDoUpdate()'>" +
	"<p style='min-width:120px; margin-left:20px;'>Quantity:</p><input class='form-control' type='text' value='1' id='quantity'></div>" +
    ...
    "Message:<br>" +
    "<div class='input-group'><textarea class='form-control' rows='7' id='message'></textarea></div>" +
    "</div></div>" +
    "<div style='margin-top: 10px;' class='card'>" +
