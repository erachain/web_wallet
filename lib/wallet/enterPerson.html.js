var enterPerson = "<h5>Send Person Info in ERaChain</h5>" +
	...
	//"<input style='margin-top:10px;' class='form-control' type='button' id='parseinfo' value='Parse Info Byte to Person' OnClick='enterPersonParseinfo()'>" +
    //"<div style='margin-top:10px;' class='card'>" +
    //"<div class='card-header'>Person Parse Info</div>" +
    //"<div class='card-block'>" +
	//"Name:<br><td><input class='form-control' type='text' value='' id='namePerson'>" +
	//"Description<br><textarea class='form-control' rows=5 id=description></textarea>" +
	//"Image<span id='img' ></span>"+
    ...
    //"</div><div class='row'>"+
    //"<div class='col-sm'>birthLatitude:<br><input class='form-control' type='text' value='' id='birthLatitude'></div>" +
	...
	"<input class='btn btn-default btn-block' type='button' value='POST Process' OnClick='doPostProcess()'>"+
	"Result:<br>"+
