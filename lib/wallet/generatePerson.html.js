var generatePerson = "<h5>Person Info</h5>" +
    ...
    "<div class='image-size-label'>Scale image" +
    "<input style='margin-right:20px;' type='range' class='cropit-image-zoom-input'></div>" +
    "<div class='image-size-label'>Change height" +
    "<input id='heightChanger' type='range' class='cropit-image-height-input'></div>" +
    "</div>"+
    "<div class='col-sm'>" +
