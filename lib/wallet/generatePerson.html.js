var generatePerson = "<h5>Generate Person</h5>" +
    ...
    "<input type='file' id='files' class='cropit-image-input'>" +
    ...
    "<div style='height: 180px;'>"+
        "<div class='image-size-label' style='text-align:center;'>Scale image" +
            "<input style='width:250px;' type='range' class='cropit-image-zoom-input' id='cropit-image-zoom-input'>" +
        "</div>" +
        ...
        "<div style='margin-top:10px;' class='input-group'><input type='submit' value='crop' id='submitImage'>" +
        "<input style='margin-left:20px;' type='submit' value='save raw' id='saveRaw' onclick='saveRaw()'></div>" +
    "</div>"+   
    "</div>"+
    "</div>" +
    "</div></div>" +
    "</div>" +
    "<div class='col-sm' style='height:600px; max-width:300px;'>final image: <span id='imgsize'></span>" +
    "<br><div style='margin-top:12px;' id='img'>" +
    "</div>" +
    "</div>" +
    "</div></div>" +
    "<div class='container' style='margin-top:10px;'>" +
    "<div class='row'>" +
    "<div class='col-sm'>birthday:<br>" +
    "<input class='form-control' type='date' value='02/01/1980' id='birthday'>"+
    "</div>" +
    ...
    "</div><div class='row'>"+
    "<div class='col-sm'>deathday:<br><input class='form-control' type='date' value='01/01/1980' id='deathday'></div>" +
    "<div class='col-sm'>birthLongitude:<br><input class='form-control' type='text' value='141.3' id='birthLongitude'></div>" +
    "</div><div class='row'>" +
    "<div class='col-sm'>gender:<br>" + //<input class='form-control' type='text' value='0' id='gender'>
