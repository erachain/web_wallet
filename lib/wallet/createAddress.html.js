	...
	"Base Seed:<br>" +
	"<div class='input-group'><input class='form-control' type='text' size=60 value='' id='base58BaseSeed'/>&nbsp;<input class='btn btn-default' type='button' value='get Account Seed' onclick='doAccounts()'/></div>" +
	"WEB URL:<br>" +
  ...
  "Private Key:" +
	...
	"Public Key:" +
	"<div class='input-group'><input class='form-control' type='text' value='' id='base58AccountPublicKey'/>&nbsp;<input class='btn btn-default' type='button' value='get Public Key' onclick='doAccountAddressFromPublicKey()'/></div>" +
	"Address:" +
