				...
				httpRequest.onreadystatechange = function() {
					if (this.status == 200) {
						try {
							...
							document.getElementById("personInfo").innerHTML = "Name: <b>" + personArray["name"] + "</b><br>Birthday: <b>" + bdate.getDate() + "-" + bdate.getMonth() + "-" + bdate.getFullYear() + "</b>";
						} catch (e) { }
					}
				};
				httpRequest.send();
