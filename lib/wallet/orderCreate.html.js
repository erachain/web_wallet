var orderCreate = "<h5>Create Exchange Order</h5>"+
	...
	"<p style='min-width:150px;'>&nbsp;Have Ammount:</p><input class='form-control' type='text' value='0.0001' id='haveammount' oninput='validAmountScale(this)' onfocus='sendAssetDoUpdate(\"haveasset\")'></div>"+
	...
	"<p style='min-width:150px;'>&nbsp;Want Ammount:</p><input class='form-control' type='text' value='0.01' id='wantammount' oninput='validAmountScale(this)' onfocus='sendAssetDoUpdate(\"wantasset\")'></div>"+
