var setStatus = "<h5>Set Status</h5>" +
    ...
    "<div class='input-group' style='margin-top:20px;'>"+
    "<p style='min-width:120px;'>Integer1 (%1):</p><input class='form-control' type='text' value='' id='value1' onkeyup='only_integer(this)'><p style='min-width:120px;'>String1 (%3):</p><input class='form-control' type='text' value='' id='string1'></div>"+
	"<div class='input-group' style='margin-top:20px;'>"+
    "<p style='min-width:120px;'>&nbsp;Integer2 (%2):</p><input class='form-control' type='text' value='' id='value2' onkeyup='only_integer(this)'><p style='min-width:120px;'>&nbsp;String2 (%4):</p><input class='form-control' type='text' value='' id='string2'></div>"+
