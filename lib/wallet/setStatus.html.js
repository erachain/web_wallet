var setStatus = "<h5>Set Status</h5>" +
    ...
    "<div class='input-group' style='margin-top:20px;'>"+
    "<p style='min-width:120px;'>Value1:</p><input class='form-control' type='text' value='' id='value1'><p style='min-width:120px;'>&nbsp;Value2:</p><input class='form-control' type='text' value='' id='value2'></div>"+
	"<div class='input-group' style='margin-top:20px;'>"+
    "<p style='min-width:120px;'>String1:</p><input class='form-control' type='text' value='' id='string1'><p style='min-width:120px;'>&nbsp;String2:</p><input class='form-control' type='text' value='' id='string2'></div>"+
